...
function displayProductDetail(product) {
    ...
    for (let i = 0; i < 5; i++) {
        ...
        } else if (i === Math.floor(product.rating.rate) && product.rating.rate % 1 !== 0) {
...
const productDetailData = findProductById(productId);


displayProductDetail(productDetailData);